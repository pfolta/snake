...
var CanvasHandler = function () {
  ...
  _createClass(CanvasHandler, [{
    ...
    value: function drawBackground() {
      for (var i = 0; i < GameConfig.X_TILES; i++) {
        for (var j = 0; j < GameConfig.Y_TILES; j++) {
          var tile = new _tile2.default(i, j);
          var color = void 0;

          if ((i + j) % 2 == 0) color = GameConfig.BACKGROUND_COLOR_1;else color = GameConfig.BACKGROUND_COLOR_2;
...
var Snake = function () {
  function Snake() {
    ...
    for (var i = 1; i < GameConfig.INITIAL_SNAKE_SIZE; i++) {
